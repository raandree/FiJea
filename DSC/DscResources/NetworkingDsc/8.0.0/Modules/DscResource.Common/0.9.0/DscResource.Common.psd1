@{
    ...
    FunctionsToExport = @('Assert-BoundParameter','Assert-IPAddress','Assert-Module','ConvertTo-CimInstance','ConvertTo-HashTable','Get-LocalizedData','Get-TemporaryFolder','New-InvalidArgumentException','New-InvalidOperationException','New-InvalidResultException','New-NotImplementedException','New-ObjectNotFoundException','Remove-CommonParameter','Set-PSModulePath','Test-DscParameterState','Test-IsNanoServer')
