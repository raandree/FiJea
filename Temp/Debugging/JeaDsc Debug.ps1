...
Import-Module -Name 'C:\Program Files\WindowsPowerShell\Modules\JeaDsc\0.8.0\Modules\DscResource.Common\0.10.0\DscResource.Common.psd1'
Import-Module -Name 'C:\Program Files\WindowsPowerShell\Modules\JeaDsc\0.8.0\Modules\JeaDsc.Common\JeaDsc.Common.psm1'

$script:localizedDataRole = Get-LocalizedData -DefaultUICulture en-US -FileName 'JeaRoleCapabilities.strings.psd1' -BaseDirectory 'C:\Program Files\WindowsPowerShell\Modules\JeaDsc\0.8.0'
...
$script:localizedDataSession = Get-LocalizedData -DefaultUICulture en-US -FileName 'JeaSessionConfiguration.strings.psd1' -BaseDirectory 'C:\Program Files\WindowsPowerShell\Modules\JeaDsc\0.8.0'
...
$endpoints = Get-Content -Path C:\Git\FiJea\DSC\DscConfigData\JEA\Endpoints.yml | ConvertFrom-Yaml

$c = [JeaSessionConfiguration]::new()
$endpointIndex = -1
$c.RoleDefinitions = $endpoints.JeaEndpoints.EndPoints[$endpointIndex].RoleDefinitions | ConvertTo-Expression
$c.SessionType = $endpoints.JeaEndpoints.EndPoints[$endpointIndex].SessionType
$c.Name = $endpoints.JeaEndpoints.EndPoints[$endpointIndex].Name
$c.Ensure = $endpoints.JeaEndpoints.EndPoints[$endpointIndex].Ensure
